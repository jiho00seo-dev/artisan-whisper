/**
 * 장인의 갈무리: Artisan Archive Data Engine
...
const curationData = {
    "all": [
        {
            ...
            tag: "#서재의_품격",
            desc: "공산품이 흉내 낼 수 없는 묵직한 존재감. 이탈리아 베지터블 가죽의 질감이 당신의 업무 공간을 정돈합니다. 시간이 흐를수록 깊어지는 당신만의 에이징의 멋을 경험하세요.",
        ...
        },
        {
            ...
            tag: "#세상에_단_하나뿐인_쉼표",
            desc: "똑같은 모양이 하나도 없는, 흙의 숨결을 그대로 담은 다기입니다. 거친 질감 사이로 흐르는 차 한 잔의 평온함을 나에게, 혹은 소중한 이에게 선물하세요.",
    ...
    "gift": [
        {
            id: "wood_diffuser",
            persona: "소중한 사람을 위한 정중한 선택",
            title: "쿤달 블렌딩 수제 화산석 디퓨저 (편백)",
            tag: "#사려깊은_존중",
            desc: "흔한 디퓨저와는 다른, 화산석의 미세한 기공으로 스며드는 자연의 향. 소중한 이의 공간에 숲의 평온함을 더해주는 가장 정중한 선택입니다.",
        ...
        },
        {
            ...
            title: "황금비율 금속 책갈피",
            tag: "#당신의_문장을_기억합니다",
            desc: "책을 사랑하는 이에게 이보다 더 정교한 예우는 없습니다. 얇지만 단단한, 장인의 세밀한 가공이 돋보이는 단 하나의 기록 도구입니다.",
